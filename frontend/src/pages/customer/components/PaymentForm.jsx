...
const PaymentForm = ({ handleBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const options = {
        key: "rzp_test_Wlb0ga2B3LisMA", // Replace with your Razorpay key ID
        amount: amount.toString(),
        currency: currency,
        name: "Ayurvedic eshop",
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>Payment Method - Ayurvedic eshop</title>
        <meta
          name="description"
          content="Proceed with your payment securely through Razorpay. Ayurvedic eshop, payment method, secure payment."
        />
        <meta
          name="keywords"
          content="payment method, Ayurvedic eshop, Razorpay, secure payment"
        />
      </Helmet>
